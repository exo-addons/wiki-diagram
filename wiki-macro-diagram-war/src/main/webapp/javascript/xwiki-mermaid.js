...
(function($, mermaidJS) {
      ...
      $(".mermaid-diagram").each(function(i, mermaidholder) {
        ...
        if (mermaidsyntax && mermaid.parse(mermaidsyntax)) {
          var cb = function(svgGraph) {
            $(mermaidholder).html(svgGraph);
          }
          mermaidAPI.render('mermaidGraph' + i, mermaidsyntax, cb)
  ...
  $("#UIWikiMaskWorkspace").change(refreshDiagrams);
  $("#UIWikiPortlet").change(refreshDiagrams);
  refreshDiagrams();
})(jQuery, mermaidJS);
